 ...
 /* java Profile 2 */ 
        var initDemo = function() {
          ...
          var stories = new Insta('stories', {
            ...
            {
                id: "Documentation_1",
                photo: "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgJ0G_QA_rqaHkzXRE9PNMjxmohGzNKN0r5Q49hDsen-5qzXt5rcSw02FsT8m_WN8ShvEx_H-Uvu01PGmV-Y-J6ceTD9hiop1WK1mQbyB0WETcc8JyIt2M0OldlO85scWsF3zUlBc7F1H9ARFulLB7EM8bZ7mE7AYc_-fW3vJhEftf6IPjxps9aHu02Vgk/s320/techlystb_logo_aveestb.xyz.webp",
                name: "Techlystb",
                link: "",
                items: [
                  Insta.buildItem("Documentation_2", "photo", 5, "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgT9lqaSZYi6scykZLnuLDFdZg23PuL8Dss_UeZqmzlsOhNr5qwuMNk7oS2PV1xDC-t3OHhkPvSWo9qiJmaKVnT1kD4xAjh3bLww2ZCaYLshTtifgv8AKU3BWvzILJho0OG8oOBBHVZRlpzhe1QlZkrwWgQrqFbQSaXBKbpxc0jgqfY4JCU_XL_bUfADu8/s1280/20231224_182405.jpg_aveestb.xyz.webp", '', false, false, ),

                  Insta.buildItem("Documentation_2", "photo", 5, "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEh7PoA6GhjQ9Mjy8v_d8_xaxQYslTkCUfbnYkrPe4qbUUvhhwRA-MDeVDy-cF811BYhl8OKjejf7Uazi2neAscdbvhIOgbZzk3OkI1ayGrcLEwWpPU_pBuHGbXwyECBOOn0ZIZdwnRYnKdawx4zKmgSk21eLHliumqTJzCttv-bsEJNHCe0vwlK1p0Td8o/s1280/20231224_193657.jpg_aveestb.xyz.webp", '', 'https://techlystb.blogspot.com/p/tools.html', false, ),

                  Insta.buildItem("Documentation_2", "photo", 5, "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjTtjo_4_MHK9JHpEGhSETWC_PMggxK9aknalRe4C47fC2CYgsczozyntETEWdpkryUvjS-88rbWvYCB1czWgvhDeut4AS5sc47fRpNJ-XEhCvSr2OLriZY7fUplszhW2e8kEK4z-7SPMENEgr3uaEPneN9d-aAQDC88o1u8bWbaN0A_EYumC-YEwhla7Q/s1280/20231224_202255.png_aveestb.xyz.webp", '', false, false, ),
                ]
              },
              // END OF CONTENT
            ]
        ...
        initDemo();
/* App Search Box */                                                                                                                                                          
       var inputId= 'filter-search'; var itemsData= 'filter-value'; var displaySet = false; var displayArr = []; function getDisplayType(element) {var elementStyle = element.currentStyle || window.getComputedStyle(element, ""); return elementStyle.display;} document.getElementById(inputId).onkeyup = function() {var searchVal = this.value.toLowerCase(); var filterItems = document.querySelectorAll('[' + itemsData + ']'); for(var i = 0; i < filterItems.length; i++) {if (!displaySet) {displayArr.push(getDisplayType(filterItems[i])); } filterItems[i].style.display = 'none'; if(filterItems[i].getAttribute('filter-value').indexOf(searchVal) >= 0) {filterItems[i].style.display = displayArr[i];}} displaySet = true;}

/* Scroll Up Button */var offset = 0; window.onscroll = function () {document.documentElement.scrollTop > offset ? document.querySelector('.tutTop').classList.add('vsbl') : document.querySelector('.tutTop').classList.remove('vsbl')};
/* Progress Side Bar */
...
/* WhatsApp Chat */  document.addEventListener("DOMContentLoaded", function () {
    const icLg = document.querySelector('.ic-lg');
    const botForm = document.querySelector('.my-bot');

    icLg.addEventListener('click', function () {
      icLg.classList.toggle('yoo');
      botForm.classList.toggle('yee');
    });
  });
